<?php  
	...
	include "controller/act_edit_lain.php";
?>
	...
	<div class="box-body">
		<form action="" method="post" class="form-horizontal" enctype="multipart/form-data" accept-charset="utf-8">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" name="judul" class="form-control" required placeholder="Masukan Judul" value="<?php echo $data1['judul'] ?>" />
				</div>
			</div>
			<div class="form-group">
				<label for="" class="col-sm-3 control-label">Deskripsi</label>
				<div class="col-sm-8">
					<textarea name="desk" id="editor" cols="80" rows="10"><?php echo $data1['deskripsi'] ?></textarea>	
				</div>
			</div>
			<div class="form-group">
				<label for="" class="col-sm-3 control-label">Cover : </label>
				<div class="col-sm-5">
					<img src="image/info/<?php echo $data1['cover'] ?>" alt="" width="300" height="200">
				</div>
			</div>
			<div class="form-group">
