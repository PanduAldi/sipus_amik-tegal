...
<div class="row">
	<div class="col-lg-5 col-xs-12" align="center">
		<img class="img-thumbnail" src="image/info/<?php echo $fetch_det['cover'] ?>" alt="" width="200" height="300">
	</div>
		...
		<table class="table table-striped">
			<tbody>
				<tr>
					<td></td>
					<td></td>
					<td align="right"><a href="?module=info&page=lain" title="Kembali">Kembali Ke Halaman Berita</a></td>
				</tr>
				<tr>
